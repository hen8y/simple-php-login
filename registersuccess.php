...
<head>
    ...
    <title>SharedSub | Registration Success</title>
...
<body>
    <div class="container">
        <div class="form">
                <center>
                    <p class="head1">Registration Successful</p><br>
                    <img src="update.png" alt="reset password" class="reset">
                    <br>
                    <br>
                    <p style="font-size: 14px;float: center;margin-right: 11px;font-style: italic;">Your account password was registered succeessfully</p><br>
